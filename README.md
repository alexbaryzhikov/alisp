...
Alisp program is a hierarchy of expressions. If write multiple expressions on the outermost level then the "root" expression is a block statement, and provided automatically. Alisp expressions have form
```
(token0 token1 ...)
```
